...
## Project Structure
    ...
    ├── orlando_for_sale_si_30036  # Django project configurations
...
1. Clone this repo and `cd orlando_for_sale_si_30036`
...
2. Clone this repo and `cd orlando_for_sale_si_30036`
